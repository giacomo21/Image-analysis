...
for i in NT['slices_intensity']:
	whole_intensity_NT.append(i[1])

whole_intensity_LPS100 = []
for i in LPS100['slices_intensity']:
	whole_intensity_LPS100.append(i[1])

whole_intensity_LPS100SB = []
for i in LPS100SB['slices_intensity']:
	whole_intensity_LPS100SB.append(i[1])

whole_intensity_LPS500 = []
for i in LPS500['slices_intensity']:
	whole_intensity_LPS500.append(i[1])

whole_intensity_LPS500SB = []
...
#BP_whole_LPS100 = output.boxplot(whole_intensity_LPS100, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'BP_whole_LPS100.png', xlab = 'Slices', ylab = 'Intensity')

#BP_whole_LPS100SB = output.boxplot(whole_intensity_LPS100SB, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'BP_whole_LPS100+SB.png', xlab = 'Slices', ylab = 'Intensity')

#BP_whoile_LPS500 = output.boxplot(whole_intensity_LPS500, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'BP_whole_LPS500.png', xlab = 'Slices', ylab = 'Intensity')

#BP_whole_LPS500SB = output.boxplot(whole_intensity_LPS500SB, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'BP_whole_LPS500+SB.png', xlab = 'Slices', ylab = 'Intensity')
