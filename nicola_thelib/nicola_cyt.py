...
output.histogram(cyt_intensity_NT, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'hist_cyt_NT.png')

output.histogram(cyt_intensity_LPS100, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'hist_cyt_LPS100.png')

output.histogram(cyt_intensity_LPS100SB, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'hist_cyt_LPS100SB.png')

output.histogram(cyt_intensity_LPS500, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'hist_cyt_LPS500.png')

output.histogram(cyt_intensity_LPS500SB, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'hist_cyt_LPS500SB.png')
