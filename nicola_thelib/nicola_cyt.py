...
output.histogram(cyt_intensity_NT, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'no_otsu_hist_cyt_NT.png', log = True, a = 'step')

output.histogram(cyt_intensity_LPS100, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'no_otsu_hist_cyt_LPS100.png', log = True, a = 'step')

output.histogram(cyt_intensity_LPS100SB, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'no_otsu_hist_cyt_LPS100SB.png', log = True, a = 'step')

output.histogram(cyt_intensity_LPS500, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'no_otsu_hist_cyt_LPS500.png', log = True, a = 'step')

output.histogram(cyt_intensity_LPS500SB, labels = ['Slice1', 'Slice2', 'Slice3', 'Slice4'], outfile = 'no_otsu_hist_cyt_LPS500SB.png', log = True, a = 'step')
