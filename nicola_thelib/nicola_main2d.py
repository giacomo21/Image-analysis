...
#ACdata = nicola_loader.load_slices(LPS500)
#slices_1_gray = []
#for i in NTdata:
#	slices_1_gray.append([])
...
def boxplot(A, B, C, D):
	box = plt.boxplot([A, B, C, D])
	plt.xlabel('Conditions')
	plt.ylabel('Pixel values')
	plt.legend()
	plt.show()

BP_NT = boxplot(slices_1_intensity[0], slices_1_intensity[1], slices_1_intensity[2], slices_1_intensity[3])
