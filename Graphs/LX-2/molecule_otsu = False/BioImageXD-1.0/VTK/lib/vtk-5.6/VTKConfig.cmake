...
SET(VTK_INCLUDE_DIRS "${VTK_INSTALL_PREFIX}/include/vtk-5.6;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include/python2.6;/usr/lib/jvm/java/include;/usr/lib/jvm/java/include/linux;/usr/lib/jvm/java/include")
...
SET(VTK_RUNTIME_LIBRARY_DIRS "${VTK_INSTALL_PREFIX}/lib/vtk-5.6")
...
SET(VTK_LOAD_CMAKE_EXTENSIONS_MACRO "/media/hdd2/VTK/vtk-5.6.0/CMake/vtkLoadCMakeExtensions.cmake")
...
SET(VTK_TK_INTERNAL_DIR "${VTK_INSTALL_PREFIX}/include/vtk-5.6/TclTk/internals/tk8.5")
SET(VTK_TK_RESOURCES_DIR "")

# The Java configuration.
SET(VTK_JAVA_JAR "${VTK_INSTALL_PREFIX}/lib/vtk-5.6/java/vtk.jar")
...
SET(VTK_PYTHONPATH_DIRS "${VTK_INSTALL_PREFIX}/lib/python2.6/site-packages;${VTK_INSTALL_PREFIX}/lib/python2.6/site-packages")
