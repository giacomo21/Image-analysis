...
class itkQuaternionRigidTransformD(ITKRigidTransformsPython.itkRigid3DTransformD):
    """Proxy of C++ itkQuaternionRigidTransformD class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    InputSpaceDimension = _itkQuaternionRigidTransformPython.itkQuaternionRigidTransformD_InputSpaceDimension
    OutputSpaceDimension = _itkQuaternionRigidTransformPython.itkQuaternionRigidTransformD_OutputSpaceDimension
    SpaceDimension = _itkQuaternionRigidTransformPython.itkQuaternionRigidTransformD_SpaceDimension
    ParametersDimension = _itkQuaternionRigidTransformPython.itkQuaternionRigidTransformD_ParametersDimension
    def __New_orig__():
        """__New_orig__()"""
    ...
    def SetRotation(self, *args):
        """SetRotation(self, vnl_quaternion<(double)> rotation)"""
        return _itkQuaternionRigidTransformPython.itkQuaternionRigidTransformD_SetRotation(self, *args)

    def GetRotation(self):
        """GetRotation(self) -> vnl_quaternion<(double)>"""
    ...
    def GetPointer(self):
        """GetPointer(self) -> itkQuaternionRigidTransformD"""
