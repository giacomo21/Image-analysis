...
class vnl_matrix_refD(vnl_matrixPython.vnl_matrixD):
    ...
    def __init__(self, *args): 
        """
        __init__(self, unsigned int m, unsigned int n, double datablck) -> vnl_matrix_refD
        __init__(self, vnl_matrix_refD other) -> vnl_matrix_refD
        """
    ...
    def non_const(self):
        """non_const(self) -> vnl_matrix_refD"""
...
class vnl_matrix_refF(vnl_matrixPython.vnl_matrixF):
    ...
    def __init__(self, *args): 
        """
        __init__(self, unsigned int m, unsigned int n, float datablck) -> vnl_matrix_refF
        __init__(self, vnl_matrix_refF other) -> vnl_matrix_refF
        """
    ...
    def non_const(self):
        """non_const(self) -> vnl_matrix_refF"""
