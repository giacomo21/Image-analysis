...
class itkComplexToModulusImageFilterICF2IF2_Superclass(itkInPlaceImageFilterBPython.itkInPlaceImageFilterICF2IF2):
    ...
    def GetFunctor(self, *args):
        """
        GetFunctor(self) -> itk::Function::ComplexToModulus<(std::complex<(float)>,float)>
        GetFunctor(self) -> itk::Function::ComplexToModulus<(std::complex<(float)>,float)>
        """
    ...
    def SetFunctor(self, *args):
        """SetFunctor(self, itk::Function::ComplexToModulus<(std::complex<(float)>,float)> functor)"""
        return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF2IF2_Superclass_SetFunctor(self, *args)
    ...
    def cast(*args):
        ...
        return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF2IF2_Superclass_cast(*args)

    cast = staticmethod(cast)
    def GetPointer(self):
        """GetPointer(self) -> itkComplexToModulusImageFilterICF2IF2_Superclass"""
...
def itkComplexToModulusImageFilterICF2IF2_Superclass___New_orig__():
  """itkComplexToModulusImageFilterICF2IF2_Superclass___New_orig__()"""
  return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF2IF2_Superclass___New_orig__()

def itkComplexToModulusImageFilterICF2IF2_Superclass_cast(*args):
...
class itkComplexToModulusImageFilterICF3IF3_Superclass(itkInPlaceImageFilterBPython.itkInPlaceImageFilterICF3IF3):
    ...
    def SetFunctor(self, *args):
        """SetFunctor(self, itk::Function::ComplexToModulus<(std::complex<(float)>,float)> functor)"""
        return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF3IF3_Superclass_SetFunctor(self, *args)
    ...
    def cast(*args):
        ...
        return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF3IF3_Superclass_cast(*args)

    cast = staticmethod(cast)
    def GetPointer(self):
        """GetPointer(self) -> itkComplexToModulusImageFilterICF3IF3_Superclass"""
...
def itkComplexToModulusImageFilterICF3IF3_Superclass___New_orig__():
  """itkComplexToModulusImageFilterICF3IF3_Superclass___New_orig__()"""
  return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF3IF3_Superclass___New_orig__()

def itkComplexToModulusImageFilterICF3IF3_Superclass_cast(*args):
...
class itkComplexToModulusImageFilterICF2IF2(itkComplexToModulusImageFilterICF2IF2_Superclass):
    ...
    def cast(*args):
        ...
        return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF2IF2_cast(*args)

    cast = staticmethod(cast)
    def GetPointer(self):
        """GetPointer(self) -> itkComplexToModulusImageFilterICF2IF2"""
...
def itkComplexToModulusImageFilterICF2IF2___New_orig__():
  """itkComplexToModulusImageFilterICF2IF2___New_orig__()"""
  return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF2IF2___New_orig__()

def itkComplexToModulusImageFilterICF2IF2_cast(*args):
...
class itkComplexToModulusImageFilterICF3IF3(itkComplexToModulusImageFilterICF3IF3_Superclass):
    ...
    def cast(*args):
        ...
        return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF3IF3_cast(*args)

    cast = staticmethod(cast)
    def GetPointer(self):
        """GetPointer(self) -> itkComplexToModulusImageFilterICF3IF3"""
...
def itkComplexToModulusImageFilterICF3IF3___New_orig__():
  """itkComplexToModulusImageFilterICF3IF3___New_orig__()"""
  return _itkComplexToModulusImageFilterPython.itkComplexToModulusImageFilterICF3IF3___New_orig__()

def itkComplexToModulusImageFilterICF3IF3_cast(*args):
